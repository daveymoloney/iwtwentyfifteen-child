	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
			...
			<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'twentyfifteen' ) ); ?>" class="imprint">
				<?php printf( __( 'daveymoloney.com is proudly powered by %s', 'twentyfifteen' ), 'WordPress' ); ?>
			</a><br />
			...
			<a href="https://creativecommons.org/licenses/by/3.0/"><img src="/wp-content/themes/iwtwentyfifteen/img/cc-commons-badge.png" alt="Creative Commons Attribution 3.0" style="image-rendering:pixelated;" width="80" height="15"></a><br> © 2018-2020 David Moloney |<br>
		</div><!-- .site-info -->
	</footer><!-- .site-footer -->
